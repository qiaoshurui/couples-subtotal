    ...
    "paths": {
        ...
        "/api/v1/delete/photo-album": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"success\":true,\"data\":{},\"msg\":\"相册及相册照片删除成功\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/v1/photo-album/list": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "分页获取相册列表成功",
                        "schema": {
                            "$ref": "#/definitions/dto.AlbumListRes"
                        }
                    }
                }
            }
